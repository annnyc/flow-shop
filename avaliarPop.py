...
# instancia = listas m X n
# solucao = lista de inteiros
...
def avaliarPop(populacao: List[List[int]], instancia: List[List[int]]) -> List[int]:
  return [makespan(instancia, solucao) for solucao in populacao]
